...
{APPLY}     : {token, {apply, TokenLine, TokenChars}}.
...
{LISP}      : {token, {lisp, TokenLine, TokenChars}}.
{MATLAB}    : {token, {matlab, TokenLine, TokenChars}}.
...
{NOREPLACE} : {token, {noreplace, TokenLine, TokenChars}}.
{RBODY}     : {token, {rbody, TokenLine, TokenChars}}.
...
{TASK}      : {token, {task, TokenLine, TokenChars}}.
